...
<tr>
	...
	<!-- <td><label><?php echo $orderData;?><?=form_hidden('orderData',$orderData)?></label></td> -->
		<td><? $attributes = array('id' => 'orderData', 'name' => 'orderData','class'=>'login_input', 'tabindex' => '1', 'value' => $orderData); ?>
...
<tr>
	...
	<td><? $attributes = array('id' => 'paymentAmount', 'name' => 'paymentAmount','class'=>'login_input', 'tabindex' => '1', 'value' => $paymentAmount); ?>
		<label><?=form_input($attributes)?></label>
	</td>
</tr>
...
<?php echo $this->load->view(THEME_FOLDER . '/includes/footer_new.php');?>
