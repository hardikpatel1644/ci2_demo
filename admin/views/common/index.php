		...
		<div id="content-table-inner">
			...
			<!--	<div id="message-blue">
				...
				<th class="table-header-check"><a id="toggle-all" ></a> </th>
					...
					<th class="table-header-options line-left minwidth-1"><a href="#">Action</a></th>
				
				</tr>
				<?php foreach($asResult as $asValue):?>
				<tr>
					<td><input  type="checkbox"/></td>
					<td><?php echo $asValue['title']?></td>
					<td><?php echo $asValue['short_desc']?></td>					
																							
					<td class="options-width">
					<a href="<?php echo site_url('cms/index/'.$asValue['id_cms'].'/status')?>" title="<?php echo (($asValue['status'] == '1') ? 'Active' : 'Inactive');?>" class="icon-1 info-tooltip"></a>					
					<a href="<?php echo site_url('cms/index/'.$asValue['id_cms'].'/delete');?>" title="Delete" class="icon-2 info-tooltip"></a>					
					<a href="<?php echo site_url('cms/edit/'.$asValue['id_cms']);?>" title="Edit" class="icon-2 info-tooltip"></a>
